...
void bantu(){
    ...
    namkeluar[1] = "di palak";
    namkeluar[2] = "beli ban motor";
...
void about(){
    ...
    cout << "| Muhammad Rafly        | 60900121081    |" << endl;
    cout << "-----------------------------------------|" << endl;
...
//try again
    x :
    char yn;
    cout << "Masih Ingin Tambah Transaksi ?" << endl;
    cout << "[Y/N] =>";
    cin >> yn;
    yn = toupper(yn);
